...
public class OrderCreation {
	...
	public String takeOrder(@RequestParam int amount, @RequestParam String email, @RequestParam int courseId) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay= new RazorpayClient("rzp_test_unk64DNSdJJvT6", "0wLngmPt2Y0RUXRsh2euzLbD");
		...
		return order.toString(); // order is a html page which was given by the razor pay, simply we should return that page
	}
